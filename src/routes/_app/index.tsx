      ...
      <PageHeader title="Welcome to Bullshit Corner">
        <div className="flex flex-col gap-2">
          <p className="max-w-2xl text-sm text-muted-foreground sm:text-base">
            ...
            {" "} where Host Jake Humphrey, along with Co-Hosts Otmar Szafnauer and Rob Smedley discuss, debate, and rank (or wank) fan-submitted topics surrounding Formula 1.
          </p>
          <p className="max-w-2xl text-sm text-muted-foreground sm:text-base">
